...
def sample_5 (loglike_model, prior_transform_model, datafile,priorRange):
    ...
    fig = corner.corner(result.samples, weights=result.weights, labels=['a', 'alpha', 'beta', 'gamma', 'rho0'],
